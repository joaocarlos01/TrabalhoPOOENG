...
public class Equipa {
     ...
     * @param codigo (int) codigo da equipa
     * @param nome (String) nome da equipa
     * @param escalao (String) escalão da equipa
     * @param jogador (List<Jogador>) jogadores pertencentes à equipa
     * @param treinador (List<Treinador>) treinadores pertencentes à equipa
     */

	public Equipa(int codigo, String nome, String escalao, List<Jogador> jogador, List<Treinador> treinador) {
		super();
		this.codigo = codigo;
		this.nome = nome;
		this.escalao = escalao;
 ...
 */
	...
	public void addJogador (Jogador jogador) {
		...
		if ( cartaoJogador != null) {
			throw new NumeroDuplicadoexception(jogador.getnCartaoCidadao(), jogador.getNome());
		}
	...
	public void addTreinador (Treinador treinador) {
		...
		if ( cartaoTreinador != null) {
			throw new NumeroCartaoDuplicado(treinador.getnCartaoCidadao(), treinador.getNome());
		}
	...
	public static Comparator<Jogador> nomeJogadorComparar = new Comparator<Jogador>() {
		
		public int compare(Jogador jogador1, Jogador jogador2) {
			   String nomeJogador1 = jogador1.getNome().toUpperCase();
			   String nomeJogador2 = jogador2.getNome().toUpperCase();

			 
			   return nomeJogador1.compareTo(nomeJogador2);
		}
	};
	
	public void ordenarJogadores() {
		 Collections.sort(jogador, Equipa.nomeJogadorComparar);
