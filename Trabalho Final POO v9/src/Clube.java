...
public class Clube {
     ...
     * @param codigo (int) código do clube
     * @param nome (String) nome do clube
     * @param dataFormacao (Date) data de formação
     * @param corEquipamento (String) cor do equipamento do clube
     * @param contacto (int) contacto do clube 
     * @param email (String) email do clube
     * @param morada(String) morada do clube
     * @param equipa (List<Equipa>) equipas do clube
     */

	public Clube(int codigo, String nome, Date dataFormacao, String corEquipamento, int contacto, String email,
			String morada, List<Equipa> equipa) {
		super();
		this.codigo = codigo;
		this.nome = nome;
		this.dataFormacao = dataFormacao;
